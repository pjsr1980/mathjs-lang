...
case 27:
    /*! Production::    stmt_break : BREAK ";" */

    this.$ = ['break']
    break;

case 28:
    /*! Production::    stmt_return : RETURN ";" */

    this.$ = ['return', null]
    break;

case 29:
    /*! Production::    stmt_return : RETURN func ";" */
case 30:
    /*! Production::    stmt_return : RETURN e ";" */
...
case 42:
    /*! Production::    stmt_for_args : "(" ";" ";" ")" */

    this.$ = [null, null, null];
    break;

case 43:
    /*! Production::    stmt_for_args : "(" stmt_for_init ";" ";" ")" */

    this.$ = [yyvstack[yysp - 3], null, null]
    break;

case 44:
    /*! Production::    stmt_for_args : "(" ";" e ";" ")" */

    this.$ = [null, yyvstack[yysp - 2], null]
    break;

case 45:
    /*! Production::    stmt_for_args : "(" ";" ";" stmt_list ")" */

    this.$ = [null, null, yyvstack[yysp - 1]]
    break;

case 46:
    /*! Production::    stmt_for_args : "(" ";" e ";" stmt_list ")" */

    this.$ = [null, yyvstack[yysp - 3], yyvstack[yysp - 1]]
    break;

case 47:
    /*! Production::    stmt_for_args : "(" stmt_for_init ";" e ";" ")" */

    this.$ = [yyvstack[yysp - 4], yyvstack[yysp - 2], null]
    break;

case 48:
    /*! Production::    stmt_for_args : "(" stmt_for_init ";" ";" stmt_list ")" */

    this.$ = [yyvstack[yysp - 4], null, yyvstack[yysp - 1]]
    break;

case 49:
    /*! Production::    stmt_for_args : "(" stmt_for_init ";" e ";" stmt_list ")" */
...
case 131:
    /*! Production::    matrixRows : matrixRows ";" exprList */
...
parse: function parse(input) {
    ...
    var NO_ACTION = [0, 240 /* === table.length :: ensures that anyone using this new state will fail dramatically! */];
